...
// construtor com argumentos
	...
	public FlightDTO(Long id, String title, Double score, Integer count, String image, String aeroportoorigem,
...
// copia dados da entidade flight para o FlightDTO
	...
	public FlightDTO(Flight flight) {
		...
		aeroportoorigem = flight.getAeroportoorigem();
		aeroportodestino = flight.getAeroportodestino();
		cidadeorigem = flight.getCidadeorigem();
		cidadedestino = flight.getCidadedestino();
		paisorigem = flight.getPaisorigem();
		paisdestino = flight.getPaisdestino();
		duracao = flight.getDuracao();
		datapartida = flight.getDatapartida();
		datachegada = flight.getDatachegada();
		tipovoo = flight.getTipovoo();
		tipoaviao = flight.getTipoaviao();
		matriculaaviao = flight.getMatriculaaviao();
		companhiaaerea = flight.getCompanhiaaerea();
		escalas = flight.getEscalas();
		observacao = flight.getObservacao();
