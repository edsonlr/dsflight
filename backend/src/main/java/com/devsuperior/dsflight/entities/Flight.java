...
public class Flight {
	...
	// Tentativa de resolver o problema de lazy load - com fetch = FetchType.LAZY não resolveu
	// Tentativa de resolver o problema de lazy load - com @JsonIgnore resolveu
	@JsonIgnore
	...
	public Flight(Long id, String title, Double score, Integer count, String image, String aeroportoorigem,
